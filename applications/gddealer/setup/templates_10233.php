<?php
/**
 * v1.0.233 — dealerProfile overlay: storefront layout (sidebar + main)
 */
...
try
{
    \IPS\Db::i()->replace( 'core_theme_templates', [
        ...
        'template_version'  => '1.0.233',
    ] );
}
catch ( \Throwable $e )
{
    try { \IPS\Log::log( 'templates_10233 dealerProfile replace failed: ' . $e->getMessage(), 'gddealer_upg_10233' ); }
    catch ( \Throwable ) {}
}
