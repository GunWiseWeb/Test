<?php
namespace IPS\gddealer\setup\upg_10201;
...
TEMPLATE_EOT;
		...
		try
		{
			\IPS\Db::i()->replace( 'core_theme_templates', [
				...
				'template_version'    => '1.0.201',
			] );
		}
		catch ( \Throwable $e )
		{
			try { \IPS\Log::log( 'upg_10201 dashboardCustomize replace failed: ' . $e->getMessage(), 'gddealer_upg_10201' ); } catch ( \Throwable ) {}
		}
		...
		try
		{
			\IPS\Db::i()->delete( 'core_theme_templates', [
				...
				'gddealer', 'front', 'dealers', 'dashboardCustomize', 0
			] );
		}
		catch ( \Throwable ) {}
		...
		$langStrings = [
			...
			'gddealer_front_customize_ffl_section_intro' => 'Required for the verified badge on your public profile. Admin reviews within 24 hours.',
		];
