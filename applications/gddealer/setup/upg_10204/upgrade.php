<?php
namespace IPS\gddealer\setup\upg_10204;
...
TEMPLATE_EOT;
		...
		try {
			\IPS\Db::i()->replace( 'core_theme_templates', [
				...
				'template_version'  => '1.0.204',
			] );
		} catch ( \Throwable $e ) {
			try { \IPS\Log::log( 'upg_10204 feedValidator reseed failed: ' . $e->getMessage(), 'gddealer_upg_10204' ); } catch ( \Throwable ) {}
		}

		$unmatchedTpl = <<<'TEMPLATE_EOT'
...
TEMPLATE_EOT;
		...
		try {
			\IPS\Db::i()->replace( 'core_theme_templates', [
				...
				'template_data'     => '$data',
				'template_content'  => $unmatchedTpl,
				'template_updated'  => time(),
				'template_version'  => '1.0.204',
			] );
		} catch ( \Throwable $e ) {
			try { \IPS\Log::log( 'upg_10204 unmatched reseed failed: ' . $e->getMessage(), 'gddealer_upg_10204' ); } catch ( \Throwable ) {}
		}
		...
		try {
			\IPS\Db::i()->delete( 'core_theme_templates', [
				...
				'gddealer', 'front', 'dealers', 'unmatched', 0
			] );
		} catch ( \Throwable ) {}
