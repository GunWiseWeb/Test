<?php
/**
 * v1.0.232 — dealerProfile overlay: widen to 1446px + add Info tab
 */
...
try
{
    \IPS\Db::i()->replace( 'core_theme_templates', [
        ...
        'template_version'  => '1.0.232',
    ] );
}
catch ( \Throwable $e )
{
    try { \IPS\Log::log( 'templates_10232 dealerProfile replace failed: ' . $e->getMessage(), 'gddealer_upg_10232' ); }
    catch ( \Throwable ) {}
}
