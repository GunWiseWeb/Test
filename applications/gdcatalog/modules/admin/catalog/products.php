...
class _products extends \IPS\Dispatcher\Controller
{
	...
	protected function edit()
	{
		...
		$form = new \IPS\Helpers\Form( 'edit_product', 'gdcatalog_save_product' );
		...
		$form->add( new \IPS\Helpers\Form\Select( 'gdcatalog_product_type_group', $defaultType, FALSE, [
			...
			'toggles' => [
				'firearm' => [
					'edit_product_gdcatalog_product_gun_type',
					'edit_product_gdcatalog_product_action_type',
					'edit_product_gdcatalog_product_safety_type',
					'edit_product_gdcatalog_product_trigger_type',
					'edit_product_gdcatalog_product_caliber',
					'edit_product_gdcatalog_product_capacity',
					'edit_product_gdcatalog_product_barrel_length',
					'edit_product_gdcatalog_product_overall_length',
					'edit_product_gdcatalog_product_weight_lbs',
					'edit_product_gdcatalog_product_finish',
					'edit_product_gdcatalog_product_metal_finish',
					'edit_product_gdcatalog_product_frame_finish',
					'edit_product_gdcatalog_product_stock_material',
					'edit_product_gdcatalog_product_stock_type',
					'edit_product_gdcatalog_product_sight_type',
					'edit_product_gdcatalog_product_grips',
					'edit_product_gdcatalog_product_hammer_style',
					'edit_product_gdcatalog_product_receiver_desc',
					'edit_product_gdcatalog_product_receiver_type',
					'edit_product_gdcatalog_product_frame_material',
					'edit_product_gdcatalog_product_slide_material',
					'edit_product_gdcatalog_product_features',
				],
				'shotgun' => [
					'edit_product_gdcatalog_product_action_type',
					'edit_product_gdcatalog_product_gauge',
					'edit_product_gdcatalog_product_capacity',
					'edit_product_gdcatalog_product_barrel_length',
					'edit_product_gdcatalog_product_overall_length',
					'edit_product_gdcatalog_product_weight_lbs',
					'edit_product_gdcatalog_product_choke_config',
					'edit_product_gdcatalog_product_chamber',
					'edit_product_gdcatalog_product_stock_material',
					'edit_product_gdcatalog_product_finish',
					'edit_product_gdcatalog_product_receiver_desc',
					'edit_product_gdcatalog_product_features',
				...
				'ammo' => [
					'edit_product_gdcatalog_product_caliber',
					'edit_product_gdcatalog_product_bullet_type',
					'edit_product_gdcatalog_product_bullet_weight',
					'edit_product_gdcatalog_product_muzzle_velocity',
					'edit_product_gdcatalog_product_muzzle_energy',
					'edit_product_gdcatalog_product_rounds_per_box',
					'edit_product_gdcatalog_product_boxes_per_case',
					'edit_product_gdcatalog_product_casing_material',
					'edit_product_gdcatalog_product_features',
				],
				'optic' => [
					'edit_product_gdcatalog_product_magnification',
					'edit_product_gdcatalog_product_objective_mm',
					'edit_product_gdcatalog_product_reticle',
					'edit_product_gdcatalog_product_tube_diameter',
					'edit_product_gdcatalog_product_eye_relief',
					'edit_product_gdcatalog_product_finish',
					'edit_product_gdcatalog_product_weight_lbs',
					'edit_product_gdcatalog_product_features',
				],
